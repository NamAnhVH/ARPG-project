...
var tscn = {
	"inventory_slot" : preload("res://sources/scenes/ui/inGameUI/inventory/inventory_slot.tscn"),
	"chest_slot": preload("res://sources/scenes/ui/inGameUI/inventory/chest/chest_slot.tscn"),
	"hotbar_slot": preload("res://sources/scenes/ui/inGameUI/inventory/hotbar/hotbar_slot.tscn"),
	...
	"inventory": preload("res://sources/scenes/ui/inGameUI/inventory/inventory.tscn"),
	"equipment": preload("res://sources/scenes/ui/inGameUI/inventory/equipment/equipment.tscn"),
	"chest": preload("res://sources/scenes/ui/inGameUI/inventory/chest/chest.tscn"),
	...
	"shop_slot_container": preload("res://sources/scenes/ui/inGameUI/inventory/shop/shop_slot_container.tscn"),
	"shop_slot": preload("res://sources/scenes/ui/inGameUI/inventory/shop/shop_slot.tscn"),
	"setting_container": preload("res://sources/scenes/ui/inGameUI/setting/setting_container.tscn"),
	"add_file_save_button": preload("res://sources/scenes/ui/inGameUI/setting/add_file_save_button.tscn"),
	"file_saving_container": preload("res://sources/scenes/ui/inGameUI/setting/file_saving_container.tscn"),
	"save_slot": preload("res://sources/scenes/ui/inGameUI/setting/save_slot.tscn"),
	"choose_name_panel": preload("res://sources/scenes/ui/choose_name_panel.tscn"),
	"quest_available": preload("res://sources/scenes/ui/inGameUI/quest/quest_available.tscn"),
	"quest_slot": preload("res://sources/scenes/ui/inGameUI/quest/quest_slot.tscn"),
	"quest_name": preload("res://sources/scenes/ui/inGameUI/quest/quest_name.tscn"),
	"quest_description": preload("res://sources/scenes/ui/inGameUI/quest/quest_description.tscn"),
