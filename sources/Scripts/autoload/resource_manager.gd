...
var items = {
	...
	"attack_potion_v00": preload("res://assets/items/attack_potion_v00.png"),
	"attack_potion_v01": preload("res://assets/items/attack_potion_v01.png"),
	"attack_potion_v02": preload("res://assets/items/attack_potion_v02.png"),
	"attack_potion_v03": preload("res://assets/items/attack_potion_v03.png"),
	"attack_potion_v04": preload("res://assets/items/attack_potion_v04.png"),
	"defence_potion_v00": preload("res://assets/items/defence_potion_v00.png"),
	"defence_potion_v01": preload("res://assets/items/defence_potion_v01.png"),
	"defence_potion_v02": preload("res://assets/items/defence_potion_v02.png"),
	"defence_potion_v03": preload("res://assets/items/defence_potion_v03.png"),
	"defence_potion_v04": preload("res://assets/items/defence_potion_v04.png"),
	"crit_rate_potion_v00": preload("res://assets/items/crit_rate_potion_v00.png"),
	"crit_rate_potion_v01": preload("res://assets/items/crit_rate_potion_v01.png"),
	"crit_rate_potion_v02": preload("res://assets/items/crit_rate_potion_v02.png"),
	"crit_rate_potion_v03": preload("res://assets/items/crit_rate_potion_v03.png"),
	"crit_rate_potion_v04": preload("res://assets/items/crit_rate_potion_v04.png"),
	"crit_damage_potion_v00": preload("res://assets/items/crit_damage_potion_v00.png"),
	"crit_damage_potion_v01": preload("res://assets/items/crit_damage_potion_v01.png"),
	"crit_damage_potion_v02": preload("res://assets/items/crit_damage_potion_v02.png"),
	"crit_damage_potion_v03": preload("res://assets/items/crit_damage_potion_v03.png"),
	"crit_damage_potion_v04": preload("res://assets/items/crit_damage_potion_v04.png"),
	"swift_potion_v00": preload("res://assets/items/swift_potion_v00.png"),
	"swift_potion_v01": preload("res://assets/items/swift_potion_v01.png"),
	"swift_potion_v02": preload("res://assets/items/swift_potion_v02.png"),
	"swift_potion_v03": preload("res://assets/items/swift_potion_v03.png"),
	"swift_potion_v04": preload("res://assets/items/swift_potion_v04.png")
}

var tscn = {
	"inventory_slot" : preload("res://sources/scenes/entities/inGameUI/inventory/inventory_slot.tscn"),
	"chest_slot": preload("res://sources/scenes/components/ui/inventory/chest/chest_slot.tscn"),
	"hotbar_slot": preload("res://sources/scenes/components/ui/inventory/hotbar/hotbar_slot.tscn"),
	"floor_item": preload("res://sources/scenes/entities/interactables/floor_item.tscn"),
	"cooldown": preload("res://sources/scenes/components/usable/cooldown.tscn"),
	"quantity": preload("res://sources/scenes/components/usable/quantity.tscn"),
	"inventory": preload("res://sources/scenes/entities/inGameUI/inventory/inventory.tscn"),
	"equipment": preload("res://sources/scenes/components/ui/inventory/equipment/equipment.tscn"),
	"chest": preload("res://sources/scenes/components/ui/inventory/chest/chest.tscn"),
	"indicator": preload("res://sources/scenes/components/ui/indicator.tscn"),
	"arrow": preload("res://sources/scenes/components/core/arrow.tscn"),
	"balloon": preload("res://sources/scenes/components/ui/balloon.tscn"),
	"shop_slot_container": preload("res://sources/scenes/components/ui/inventory/shop/shop_slot_container.tscn"),
	"shop_slot": preload("res://sources/scenes/components/ui/inventory/shop/shop_slot.tscn"),
	"setting_container": preload("res://sources/scenes/entities/inGameUI/setting_container.tscn"),
	"add_file_save_button": preload("res://sources/scenes/components/ui/setting/add_file_save_button.tscn"),
	"file_saving_container": preload("res://sources/scenes/components/ui/setting/file_saving_container.tscn"),
	"save_slot": preload("res://sources/scenes/components/ui/save_slot.tscn"),
	"choose_name_panel": preload("res://sources/scenes/components/ui/choose_name_panel.tscn"),
	"quest_available": preload("res://sources/scenes/components/ui/quest/quest_available.tscn"),
	"quest_slot": preload("res://sources/scenes/components/ui/quest/quest_slot.tscn"),
	"quest_name": preload("res://sources/scenes/components/ui/quest/quest_name.tscn"),
	"quest_description": preload("res://sources/scenes/components/ui/quest/quest_description.tscn"),
	"buff_slot": preload("res://sources/scenes/components/usable/buff_slot.tscn"),
	"dungeon_map": preload("res://sources/scenes/components/tileMap/dungeon_map.tscn"),
	"health_bar": preload("res://sources/scenes/components/ui/health_bar.tscn"),
	"input_button": preload("res://sources/scenes/components/ui/input_button.tscn"),
	"stone_drop": preload("res://sources/scenes/components/core/stone_drop.tscn"),
	"quest_progress_slot": preload("res://sources/scenes/components/ui/quest/quest_progress_slot.tscn")
}

var character = {
	"luna": preload("res://sources/scenes/entities/characters/npcs/luna.tscn"),
	"slime": preload("res://sources/scenes/entities/characters/battleCharacters/enemies/slime.tscn"),
	"gremlin": preload("res://sources/scenes/entities/characters/battleCharacters/enemies/gremlin.tscn"),
	"mushroom": preload("res://sources/scenes/entities/characters/battleCharacters/enemies/mushroom.tscn")
}
